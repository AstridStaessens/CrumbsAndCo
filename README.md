...
webshop gebouwd met Angular (frontend) en ASP.NET Core (backend).
...
- Solution aanmaken met drielagen architectuur
- EF Core entiteiten schrijven
- DbContext configureren
- Connection string instellen
- Eerste migratie aanmaken en uitvoeren
...
- Mollie checkout integreren in Angular
